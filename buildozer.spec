...
# (str) Package name
package.name = ytmp3converter

# (str) Package domain (needed for android/ios packaging)
package.domain = org.ytmp3converter
...
requirements = python3,kivy==2.1.0,yt-dlp,certifi,urllib3,requests,pycryptodome,websockets,brotli,mutagen,android
...
#    android.add_assets.3 = path/to/yet-another-directory3/
#android.add_assets = 
...
# (str) Use 'android.injected.signing.store.file' to use a custom keystore
...
# In most cases, sdl2 should be used.
p4a.bootstrap = sdl2
